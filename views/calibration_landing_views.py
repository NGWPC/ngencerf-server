...
def get_jobs(request):
    ...
    runs = list(CalibrationRun.objects.only('formulation_name', 'gage', 'calibration_start_period', 'calibration_end_period', 'status').values(
        'formulation_name', 'gage__gage_id', 'calibration_start_period', 'calibration_end_period', 'status__name'))
    print('run', runs)
    for r in runs:
