...
from calibration.calibration_validators import CalibrationRunValidator, ModuleCollectionValidator
    ...
    try:
        ...
        with transaction.atomic():
            ...
            for m in module_data:
                ...
                for p in parameters:
                    print('p', p)
                    CalibrationInitialParameter.objects.create(name=p.get('name'), data_type=p.get('type'), default_value=p.get('initial_value'), calibration_run=run,
