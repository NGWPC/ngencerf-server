...
from djoser_auth.models import CustomUser, ExampleUser
from djoser_auth.tests.common import create_user, mock, perform_create_mock
...
class UserCreateViewTest(
    ...
    @override_settings(AUTH_USER_MODEL="djoser_auth.CustomUser")
    ...
    @override_settings(AUTH_USER_MODEL="djoser_auth.ExampleUser")
