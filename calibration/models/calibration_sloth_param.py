...
class CalibrationSlothParam(BaseModel):
    calibration_run = models.OneToOneField('CalibrationRun', null=True, on_delete=models.SET_NULL)
    ...
    maps_to_module = models.OneToOneField('Module', null=True, on_delete=models.SET_NULL)
