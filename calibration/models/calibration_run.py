...
class CalibrationRun(BaseModel):
    ...
    forcing_dir_path = models.TextField(null=True, blank=False)
    forcing_user_dir = models.TextField(null=True, blank=False)
    forcing_source = models.TextField(null=True, blank=False)
    observational_file_path = models.TextField(null=True, blank=False)
