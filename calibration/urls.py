...
urlpatterns = [
    ...
    path('calibration/get_calibration_jobs/', calibration_landing_views.get_calibration_jobs, name="getJobs"),
    path('calibration/get_validation_jobs/', calibration_landing_views.get_validation_jobs, name="getValidationJobs"),
