...
def run_validation_job_local(validation_run: ValidationRun, input_file, output_file, worker_name, iteration):
    """
    ...
    # Prepare the argument list to pass to the shell script
    args_to_validate = [input_file, worker_name, iteration]
