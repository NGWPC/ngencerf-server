        ...
        if time_period['run_time_period'][run_name][0] and time_period['run_time_period'][run_name][1]:
            ...
            for catID in catids:
                ...
                nom_lst = ['&timing',
                           ...
                           "  " + "startdate".ljust(
                               19) + "= " + "'" + startdate + "'" + "               ! UTC time start of simulation (YYYYMMDDhhmm)",
                           ...
                           "  " + "veg_class_name".ljust(
                               19) + "= 'USGS'" + "                       ! vegetation class data source - 'MODIFIED_IGBP_MODIS_NOAH' or 'USGS'",
                           '/',
                           "",
                           '&location',
                           ...
                           "  " + "rain_snow_thresh".ljust(
                               19) + "= 0.5" + "                          ! rain-snow temperature threshold (degrees Celcius)",
                           "/",
                           "",
                           "&model_options",
...
def create_realization_file(
    ...
    if model in ["cfe_noah", "cfe_xaj_noah"]:
        ...
        output_variables = ["soil_ice_fraction", "TGS", "RAIN_RATE", "DIRECT_RUNOFF", "GIUH_RUNOFF", "NASH_LATERAL_RUNOFF",
                            "DEEP_GW_TO_CHANNEL_FLUX", "Q_OUT", "SOIL_STORAGE", "ice_fraction_schaake", "POTENTIAL_ET", "ACTUAL_ET",
